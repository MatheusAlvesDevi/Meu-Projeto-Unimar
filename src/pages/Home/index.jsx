...
export function Home() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/users/MatheusAlvesDevi/repos")
      .then((response) => response.json())
      .then((data) => setRepository(data));

    fetch("https://api.github.com/users/MatheusAlvesDevi")
      .then((response) => response.json())
  ...
  function handleCreateNewRepository(event) {
    ...
    const data = {
      ...
      name: newRepository,
      updated_at: new Date(),
      url: `https://github.com/MatheusAlvesDevi/${newRepository}`,
    };
